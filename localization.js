...
const strings = new LocalizedStrings({
  en: {
    ...
    MedisevaWallet: 'Mediseva Wallet',
    Balance: 'Balance',
    MedisevaServices: 'Mediseva Services',
    FamilyInformation: 'Family Information',
    AddFamilyMember: 'Add Family Member',
    EditProfile: 'Edit Profile',
    CartEmptyMessage: 'Your cart is empty, Add Medicines',
    ...
    UPIId: 'Enter UPI ID',
    UPIIdPlaceholder: 'e.g. user@okhdfc',
    ...
    AddMoneySuccess: 'Money added to wallet successfully',
    AddMoneyFailed: 'Failed to add money',
    MinimumAmount: 'Minimum amount is ₹100',
  ...
  hi: {
    ...
    MedisevaWallet: 'मेडिसेवा वॉलेट',
    Balance: 'बैलेंस',
    MedisevaServices: 'मेडिसेवा सेवाएं',
    AddMedicines: 'दवाएं जोड़ें',
    FamilyInformation: 'परिवार की जानकारी',
    AddFamilyMember: 'परिवार के सदस्य जोड़ें',
    EditProfile: 'प्रोफ़ाइल संपादित करें',
    CartEmptyMessage: 'आपकी कार्ट खाली है, दवाएं जोड़ें',
    AddMember: 'सदस्य जोड़ें',
    AddMoreMember: 'और सदस्य जोड़ें',
    BookLabTests:
    ...
    UPI: 'UPI / GPAY / फोनपे',
    UPIId: 'UPI ID दर्ज करें',
    UPIIdPlaceholder: 'जैसे user@okhdfc',
    CreditDebitCard: 'क्रेडिट / डेबिट कार्ड',
    CardNumber: 'कार्ड नंबर',
    CardNumberPlaceholder: 'जैसे 4111 1111 1111 1111',
    Expiry: 'समाप्ति तिथि',
    CVV: 'सीवीवी',
    ProceedToPay: 'भुगतान करें',
    AddMoneySuccess: 'वॉलेट में पैसा सफलतापूर्वक जोड़ा गया',
    AddMoneyFailed: 'पैसा जोड़ने में विफल',
    MinimumAmount: 'न्यूनतम राशि ₹100 है',
