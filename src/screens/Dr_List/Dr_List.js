...
export default function Dr_List({ navigation }) {
  ...
  const fetchDoctors = async () => {
    try {
      const response = await Instance.get('/api/v1/doctors');
  ...
  const handleSearch = (text) => {
    setSearchQuery(text);
    if (text.trim() === '') {
      applyFilter(selectedFilter, doctors);
    } else {
  ...
  const applyFilter = (filter, data = doctors) => {
    let filtered = [...data];
    if (filter === 'online') {
      filtered = filtered.filter((d) => d.isOnline);
    } else if (filter === 'experience') {
      filtered = filtered.filter((d) => (d.doctorId?.experience || 0) >= 10);
    } else if (filter === 'rating') {
      filtered = filtered.filter((d) => (d.doctorId?.rating || 0) >= 4.5);
    }
      ...
      >
          ...
          <View style={styles.doctorInfo}>
            ...
            <View style={styles.specialtyBadge}>
              ...
              <Text style={styles.specialtyText}>
                {item.doctorId?.specialization?.name || 'General Physician'}
              </Text>
            </View>
        ...
        <View style={styles.cardDetails}>
          ...
          <View style={styles.detailItem}>
            ...
            <Text style={styles.detailText}>
              {item.doctorId?.clinicAddress || 'Clinic available'}
            </Text>
          </View>
        </View>
            ...
            <View style={styles.modalContent}>
              ...
              >
                ...
                <View style={styles.modalOptionInfo}>
                  ...
                  <Text style={styles.modalOptionDesc}>Voice consultation</Text>
                </View>
              ...
              >
                <View style={[styles.modalIconBg, { backgroundColor: '#ECFDF5' }]}>
                  <Ionicons name="videocam-outline" size={28} color="#10B981" />
                </View>
                <View style={styles.modalOptionInfo}>
                  <Text style={styles.modalOptionTitle}>Video Call</Text>
                  <Text style={styles.modalOptionDesc}>Face to face consultation</Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color="#D1D5DB" />
              </TouchableOpacity>
              ...
              >
                <View style={[styles.modalIconBg, { backgroundColor: '#FEF2F2' }]}>
                  <Ionicons name="chatbubble-outline" size={28} color="#EF4444" />
                </View>
                <View style={styles.modalOptionInfo}>
                  <Text style={styles.modalOptionTitle}>Text Chat</Text>
                  <Text style={styles.modalOptionDesc}>Send messages anytime</Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color="#D1D5DB" />
              </TouchableOpacity>
            </View>
